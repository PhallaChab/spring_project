			...
			<div class="products-grids">
				...
				<div class="col-md-5 grid-single">		
						<div class="flexslider">
							  <ul class="slides">
								<li data-thumb="resources/images/z1.jpg">
									<div class="thumb-image"> <img src="resources/images/z1.jpg" data-imagezoom="true" class="img-responsive" alt=""/> </div>
								</li>
								<li data-thumb="resources/images/z2.jpg">
									 <div class="thumb-image"> <img src="resources/images/z2.jpg" data-imagezoom="true" class="img-responsive" alt=""/> </div>
								</li>
								<li data-thumb="resources/images/z4.jpg">
								   <div class="thumb-image"> <img src="resources/images/z4.jpg" data-imagezoom="true" class="img-responsive" alt=""/> </div>
								</li> 
							  </ul>
						</div>
						<!-- FlexSlider -->
		   ...
		   <div class="fashion-info">
				<div class="col-md-4 fashion-grids">
					<figure class="effect-bubba">
						<img src="resources/images/f4.jpg" alt=""/>
						<figcaption>
							<h4>Nuevo Shop</h4>
				...
				<div class="col-md-4 fashion-grids">
					<figure class="effect-bubba">
						<img src="resources/images/f5.jpg" alt=""/>
						<figcaption>
							<h4>Nuevo Shop</h4>
								<p class="cart"><a href="#">Shop</a></p>				
						</figcaption>			
				...
				<div class="col-md-4 fashion-grids">
					<figure class="effect-bubba">
						<img src="resources/images/f6.jpg" alt=""/>
						<figcaption>
							<h4>Nuevo Shop</h4>
							<p class="cart"><a href="#">Shop</a></p>							
						</figcaption>			
