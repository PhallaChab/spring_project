	...
	<div class="container">
		<div class="banner-grids">
			<div class="col-md-6 jocket">
				<div class="jock-img">
					<img src="resources/images/sht.jpg" class="img-responsive" alt="">
				</div>
				<div class="jock-text">
			...
			<div class="col-md-6 shoe">
				<div class="shoe-img">
					<img src="resources/images/shoe.jpg" class="img-responsive" alt="">
				</div>
				<div class="shoe-text">
				...
				<div class="bottom-bags">
					<div class="col-md-6 pack">
						...
						<div class="bag-img">
							<img src="resources/images/bag.jpg" class="img-responsive" alt="">
						</div>
						<div class="clearfix"></div>
					...
					<div class="col-md-6 glass">
						...
						<div class="glass-img">
							<img src="resources/images/glass.jpg" class="img-responsive" alt="">
						</div>
						<div class="clearfix"></div>
					...
					<div class="standard active" data-selector="1">
						<div class="tag-grid">
							<div class="tag-wrapper">
								<a href="single.html"><img src="resources/images/s2.jpg"
						...
						<div class="tag-grid">
							<div class="tag-wrapper">
								<a href="single.html"><img src="resources/images/s1.jpg"
									class="img-responsive" alt="" /></a>
								<div class="atc">
									<a href="single.html">Shop</a>
								</div>
						...
						<div class="tag-grid">
							<div class="tag-wrapper">
								<a href="single.html"><img src="resources/images/s3.jpg"
									class="img-responsive" alt="" /></a>
								<div class="atc">
									<a href="single.html">Shop</a>
								</div>
